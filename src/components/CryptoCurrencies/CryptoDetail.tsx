...
import { Coin } from "../../models/IModel";
...
const CryptoDetail = () => {
  ...
  const handleOnChangeTimePeriod = (value: string) => {
    setTimePeriod(value);
  };
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <p>
              An overview showing statistics of {cryptoDetails.name} such as the
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overview showing statistics of all crypto currency</p>
          </Col>
